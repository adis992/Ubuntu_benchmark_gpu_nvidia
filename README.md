...
Starting a Benchmark
    ...
    Select the GPUs you want to stress.
    Set benchmark duration.
    Choose workload type and precision.
    Set the Power Limit. Default is 300 W.
    Start the benchmark and watch the live GPU cards update in real time.
...
After installation, open the web panel here:
    ...
    http://localhost:5000 for the local machine
    http://SERVER_IP:5000 from another machine on the network
...
For issues, questions, or suggestions:
    ...
    Check crash detection logs for hardware issues
